...
nc_basins_nf_seplains <- st_intersection(southeast_state_bounds_NC, basins_nf_seplains)

#######Attempting to obtain full watersheds that overlap with NC

nc_basins_nf_seplains <- st_contains(basins_nf_seplains, southeast_state_bounds_NC)

st_as_sf(nc_basins_nf_seplains)

# look at result
# add your code here
basins_nf_seplains_geom <- st_geometry(basins_nf_seplains)

###Trying to see what the original watersheds look like -- it worked, just took awhile
pdf(here("outputs", "nc_watersheds_only_test.pdf"), width = 11, height = 8.5)
ggplot(data = basins_nf_seplains_geom) +
  geom_sf()
  dev.off()

pdf(here("outputs", "nc_watersheds_test.pdf"), width = 11, height = 8.5)
ggplot(data = nc_basins_nf_seplains) +
  geom_sf()
  dev.off()
