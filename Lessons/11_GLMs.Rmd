...
#Reject null hypotheses that variances are equal
...
# Format ANOVA as lm
#The intercept is plotIDNIWO_041; significances are measured against that plot
#Overall p-value given
...
##Residuals vs. Fitted -- looking for a straight line
##Normal Q-Q -- want points to fit the line
##Scale-Location -- looking for a straight line
##Residuals vs. Leverage -- outliers
plot(Litter.Totals.anova2)

# Post-hoc test
#Pairwise comparisons
#Run on aov object, not lm object?
TukeyHSD(Litter.Totals.anova)

# Extract groupings for pairwise relationships
#Still use aov object
...
> Total litter biomass differs significantly among sites at the Niwot Ridge LTER (figure 1; ANOVA, F11, 198 = 4.813, p < 0.0001).
...
# Format as lm
#Intercept is first functional group and land use class alphabetically
...
Litter.anova.plot <- ggplot(Litter, aes(y = dryMass, x = nlcdClass, color = functionalGroup)) +
  geom_boxplot() + 
  labs(y = "Dry Mass", x = "NLCD Class", color = "Functional Group") +
  scale_x_discrete(labels = c("Evergreen Forest", "Herbaceous Grassland", "Shrub Scrub")) +
  stat_summary(geom = "text", fun.y = max, vjust = -1, 
               size = 3.5,
               label = c("d", "d", "d", "a", "d", "d", 
                         "d", "d", "d", "d", "d", "b", "d", "d", "d", "d",
