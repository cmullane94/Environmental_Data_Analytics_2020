...
> We reject the null hypothesis -- the true mean is less than 50
...
var.test(EPAair$Ozone ~ EPAair$Year) #true rationis not equal to one
...
O3.twosample
O3.twosample$p.value # < 0.05 -- the true mean is not equal to zero
...
ggplot(EPAair, aes(y = Ozone, x = as.factor(Year))) +
  geom_violin()
