...
\CommentTok{#2}
\CommentTok{#Looking at initial column names and date format}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Changing column sampledate to a date format}
\NormalTok{Peter_Paul_Nutrients}\OperatorTok{$}\NormalTok{sampledate <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(Peter_Paul_Nutrients}\OperatorTok{$}\NormalTok{sampledate, }\DataTypeTok{format =} \StringTok{"%Y-%m-%d"}\NormalTok{)}

\CommentTok{#Verifying change}
\KeywordTok{class}\NormalTok{(Peter_Paul_Nutrients}\OperatorTok{$}\NormalTok{sampledate)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Peter_Paul_Nutrients_wr}\OperatorTok{$}\NormalTok{month <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(Peter_Paul_Nutrients_wr}\OperatorTok{$}\NormalTok{month)}
\KeywordTok{class}\NormalTok{(Peter_Paul_Nutrients_wr}\OperatorTok{$}\NormalTok{month)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#5 Test for tn}
\CommentTok{##As linear model}
\NormalTok{tn.anova}\FloatTok{.2}\NormalTok{way.int <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ Peter_Paul_Nutrients_wr, }
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{###No significant interactions; only lakename has significant differences}
\CommentTok{##No need to form groups}

\CommentTok{#6 Test for tp}
\CommentTok{##As linear model}
\NormalTok{tp.anova}\FloatTok{.2}\NormalTok{way.int <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ Peter_Paul_Nutrients_wr, }
...
\NormalTok{theme_def <-}\StringTok{ }\KeywordTok{theme_classic}\NormalTok{(}\DataTypeTok{base_size =} \DecValTok{14}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{color =} \StringTok{"black"}\NormalTok{), }
        \DataTypeTok{legend.position =} \StringTok{"right"}\NormalTok{)}

\CommentTok{#Setting new theme as the default theme}
\KeywordTok{theme_set}\NormalTok{(theme_def)}

\CommentTok{##Plot 1 (tn)}
\CommentTok{##Groups were not created for TN, but within each month, the lake with the larger}
\CommentTok{##TN value is labelled "a" and the lake with the smaller TN value is labelled "b"}
\CommentTok{##(because the lakename significantly predicted TN concentrations)}
\NormalTok{tn.anova.plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(Peter_Paul_Nutrients_wr, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ tn_ug, }\DataTypeTok{x =}\NormalTok{ month, }
                                                     \DataTypeTok{fill =}\NormalTok{ lakename)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_boxplot}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{y =} \KeywordTok{expression}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"TN ("}\NormalTok{, mu, }\StringTok{"g/L)"}\NormalTok{)), }
       \DataTypeTok{x =} \StringTok{"Month"}\NormalTok{, }\DataTypeTok{fill =} \StringTok{"Lake Name"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_fill_manual}\NormalTok{(}\DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\StringTok{"#66c2a5"}\NormalTok{, }\StringTok{"#fc8d62"}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ylim}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{2200}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{stat_summary}\NormalTok{(}\DataTypeTok{geom =} \StringTok{"text"}\NormalTok{, }\DataTypeTok{position=}\KeywordTok{position_dodge}\NormalTok{(}\DataTypeTok{width=}\FloatTok{0.9}\NormalTok{), }
               \DataTypeTok{fun.y =}\NormalTok{ max, }\DataTypeTok{vjust =} \DecValTok{-1}\NormalTok{, }
               \DataTypeTok{size =} \FloatTok{3.5}\NormalTok{,}
               \DataTypeTok{label =} \KeywordTok{c}\NormalTok{(}\StringTok{"a"}\NormalTok{, }\StringTok{"b"}\NormalTok{, }\StringTok{"a"}\NormalTok{, }\StringTok{"b"}\NormalTok{, }\StringTok{"a"}\NormalTok{, }
                         \StringTok{"b"}\NormalTok{, }\StringTok{"a"}\NormalTok{, }\StringTok{"b"}\NormalTok{, }\StringTok{"a"}\NormalTok{, }\StringTok{"b"}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{##Plot 2 (tp)}
\NormalTok{tp.anova.plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(Peter_Paul_Nutrients_wr, }
...
\StringTok{  }\KeywordTok{stat_summary}\NormalTok{(}\DataTypeTok{geom =} \StringTok{"text"}\NormalTok{, }\DataTypeTok{position=}\KeywordTok{position_dodge}\NormalTok{(}\DataTypeTok{width=}\FloatTok{0.9}\NormalTok{), }
               \DataTypeTok{fun.y =}\NormalTok{ max, }\DataTypeTok{vjust =} \DecValTok{-1}\NormalTok{, }
               \DataTypeTok{size =} \FloatTok{3.5}\NormalTok{,}
               \DataTypeTok{label =} \KeywordTok{c}\NormalTok{(}\StringTok{"bcd"}\NormalTok{, }\StringTok{"cd"}\NormalTok{, }\StringTok{"ab"}\NormalTok{, }\StringTok{"d"}\NormalTok{, }\StringTok{"a"}\NormalTok{, }
                         \StringTok{"d"}\NormalTok{, }\StringTok{"abc"}\NormalTok{, }\StringTok{"d"}\NormalTok{, }\StringTok{"abcd"}\NormalTok{, }\StringTok{"cd"}\NormalTok{))}
...
\CommentTok{#8}
\CommentTok{##Cowplot}
\NormalTok{tp_tn_plot <-}\StringTok{ }\KeywordTok{plot_grid}\NormalTok{(tn.anova.plot }\OperatorTok{+}\StringTok{ }
\StringTok{                          }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position =} \StringTok{"none"}\NormalTok{, }
                                \DataTypeTok{axis.title.x =} \KeywordTok{element_blank}\NormalTok{(),}
                                \DataTypeTok{axis.text.x=}\KeywordTok{element_blank}\NormalTok{(),}
                                \DataTypeTok{axis.ticks.x=}\KeywordTok{element_blank}\NormalTok{(),}
                                \DataTypeTok{plot.margin =} \KeywordTok{margin}\NormalTok{(}\DataTypeTok{t =} \DecValTok{0}\NormalTok{, }\DataTypeTok{r =} \DecValTok{0}\NormalTok{, }
                                                     \DataTypeTok{b =} \DecValTok{0}\NormalTok{, }\DataTypeTok{l =} \DecValTok{0}\NormalTok{,}
                                                     \DataTypeTok{unit =} \StringTok{"cm"}\NormalTok{)),}
\NormalTok{                        tp.anova.plot }\OperatorTok{+}\StringTok{ }
\StringTok{                          }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position=}\StringTok{"none"}\NormalTok{, }
                                \DataTypeTok{plot.margin =} \KeywordTok{margin}\NormalTok{(}\DataTypeTok{t =} \DecValTok{0}\NormalTok{, }\DataTypeTok{r =} \DecValTok{0}\NormalTok{, }
                                                     \DataTypeTok{b =} \DecValTok{0}\NormalTok{, }\DataTypeTok{l =} \DecValTok{0}\NormalTok{, }
                                                     \DataTypeTok{unit =} \StringTok{"cm"}\NormalTok{)),}
                        \DataTypeTok{nrow =} \DecValTok{2}\NormalTok{, }\DataTypeTok{align =} \StringTok{"hv"}\NormalTok{)}

\NormalTok{legend <-}\StringTok{ }\KeywordTok{get_legend}\NormalTok{(tn.anova.plot }\OperatorTok{+}\StringTok{ }
...
\KeywordTok{plot_grid}\NormalTok{(legend, tp_tn_plot, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{, }\DataTypeTok{rel_heights =} \KeywordTok{c}\NormalTok{(.}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
